...
export default function HomePage() {
  return (
    // Local-only, opt-in reorder mode (via ?edit=1) is shared between the
    // header menu and the grid through this provider. Normal visitors see a
    // perfectly clean page — the menu button and panel are self-gating.
    <ReorderProvider projects={projects}>
      <main className="mx-auto min-h-screen w-full max-w-5xl px-5 pb-20 pt-4 sm:px-8 sm:pt-6">
        <PageToolbar actions={<ReorderMenu />} />
        ...
        {/* Project grid — order comes from the shared reorder context. */}
        <ProjectGrid />
