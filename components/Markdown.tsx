      ...
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => (
            <Heading
              level={1}
              className="mb-6 mt-2 text-3xl font-extrabold tracking-tight text-fg sm:text-4xl"
            >
              {children}
            </Heading>
          ),
          h2: ({ children }) => (
            <Heading
              level={2}
              className="mb-4 mt-12 border-b border-border pb-2 text-2xl font-bold text-fg"
            >
              {children}
            </Heading>
          ),
          h3: ({ children }) => (
            <Heading
              level={3}
              className="mb-3 mt-8 text-xl font-bold text-fg"
            >
              {children}
            </Heading>
          ),
          h4: ({ children }) => (
            <Heading
              level={4}
              className="mb-2 mt-6 text-lg font-semibold text-fg"
            >
              {children}
            </Heading>
          ),
          p: ({ children }) => (
            <p className="my-4 leading-relaxed text-fg/80">{children}</p>
          ),
          a: ({ href, children }) => (
            <a
              href={href}
