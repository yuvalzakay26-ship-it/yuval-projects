...
8. [דף הבית](#8-דף-הבית)
9. [קטלוג / מוצרים / חגים](#9-קטלוג--מוצרים--חגים)
10. [עיצוב ו־RTL](#10-עיצוב-וrtl)
11. [קומפוננטות מרכזיות](#11-קומפוננטות-מרכזיות)
12. [נכסים ותמונות](#12-נכסים-ותמונות)
13. [ביצועים והתאמה למובייל](#13-ביצועים-והתאמה-למובייל)
14. [SEO ונגישות](#14-seo-ונגישות)
15. [פריסה והפעלה](#15-פריסה-והפעלה)
16. [מצב הפרויקט הנוכחי](#16-מצב-הפרויקט-הנוכחי)
17. [מדריך המשך עבודה](#17-מדריך-המשך-עבודה)
18. [מה הפרויקט מוכיח](#18-מה-הפרויקט-מוכיח)
19. [תקציר לפורטפוליו](#תקציר-לפורטפוליו)
